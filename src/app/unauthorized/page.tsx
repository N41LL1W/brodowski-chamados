...
export default function UnauthorizedPage() {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-background dark:bg-slate-950 text-center p-6">
            ...
            <h1 className="text-5xl md:text-6xl font-black text-foreground dark:text-white mb-4 tracking-tighter uppercase">
                Acesso Negado
            </h1>
